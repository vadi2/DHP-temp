...
Alias: $encounter-subject-status = https://terminology.medcore.uz/ValueSet/encounter-subject-status 
Alias: $encounter-type = https://terminology.medcore.uz/ValueSet/encounter-type 
