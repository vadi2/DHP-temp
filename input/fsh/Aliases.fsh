...
Alias: $security-role-type = http://terminology.hl7.org/CodeSystem/extra-security-role-type
Alias: $security-structural-codes = http://hl7.org/fhir/sample-security-structural-roles
