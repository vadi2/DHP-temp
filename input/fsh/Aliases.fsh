...
Alias: $allergy-intolerance-type = http://hl7.org/fhir/ValueSet/allergy-intolerance-type
Alias: $allergy-clinical = http://hl7.org/fhir/ValueSet/allergyintolerance-clinical
Alias: $allerfy-verification = http://hl7.org/fhir/ValueSet/allergyintolerance-verification 