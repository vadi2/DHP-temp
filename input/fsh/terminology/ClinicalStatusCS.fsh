...
* insert SupplementCodeSystemDraft(clinical-status-cs, Clinical status translations, Clinical status supplement with translations in Uzbek and Russian, $condition-clinical)
