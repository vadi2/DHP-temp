...
* ^url = "https://terminology.dhp.uz/CodeSystem/provenance-participation-role-type-cs"
* ^experimental = true
* ^content = #supplement
...
* #legal
  ...
  * ^designation[=].value = "Юридический аутентификатор"
  * ^designation[+].language = #uz
  * ^designation[=].value = "Yuridik autentifikatsiya"
* #author
  * ^designation[0].language = #ru
