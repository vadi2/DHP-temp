...
* insert SupplementCodeSystem(encounter-status-cs, Encounter status translations, Encounter status codes with English and Russian translations, $encounter-status)
