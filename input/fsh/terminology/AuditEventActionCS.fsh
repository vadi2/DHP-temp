...
* insert SupplementCodeSystemDraft(audit-event-action-cs, Audit event action translations, Audit event action supplement with translations in Uzbek and Russian, $audit-event-action, 5.0.0)
* #C
