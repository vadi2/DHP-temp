...
* insert SupplementCodeSystemDraft(sample-security-structural-roles-cs, Sample security structural roles, Sample security structural roles with translations in Uzbek and Russian\, used in DHP as actual codes, $sample-security-structural-codes)
