...
- **Биндинги**: Используйте `required` биндинг для обязательных элементов с фиксированным набором значений. Используйте `extensible` биндинг когда разрешены дополнительные коды. **Предупреждение**: если использовать `extensible` биндинг, валидатор не сможет различить опечатки от новых допустимых кодов. Для национальных терминологий предпочитайте создание ValueSet с соответствующими переводами.
